...
namespace LocalList.API.NET.Migrations
{
    ...
    [Migration("20260728164028_AddBillingEventAnalyticsColumns")]
    partial class AddBillingEventAnalyticsColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LocalList.API.NET.Shared.Data.Entities.CityRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LocalList.API.NET.Shared.Data.Entities.Favorite", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("LocalList.API.NET.Shared.Data.Entities.Plan", b =>
                {
                    ...
                    b.Property<string>("ImportedCreatorHandle")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("imported_creator_handle");

                    b.Property<string>("ImportedFromPlatform")
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)")
                        .HasColumnName("imported_from_platform");
                    ...
                    b.HasIndex("CreatedById", "ClonedFrom")
                        .IsUnique()
                    ...
                    b.ToTable("plans", t =>
                        {
                            t.HasCheckConstraint("ck_plans_visibility_domain", "visibility IN ('private', 'unlisted', 'public')");
                        });
                });
            ...
            modelBuilder.Entity("LocalList.API.NET.Shared.Data.Entities.UserBlock", b =>
                {
                    ...
                    b.ToTable("user_blocks", t =>
                        {
                            t.HasCheckConstraint("ck_user_blocks_no_self", "blocker_id <> blocked_id");
                        });
                });
            ...
            modelBuilder.Entity("LocalList.API.NET.Shared.Data.Entities.VideoImportMetric", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("CaptionProvided")
                        .HasColumnType("boolean")
                        .HasColumnName("caption_provided");
                    ...
                    b.Property<int?>("EstimatedMediaTokens")
                        .HasColumnType("integer")
                        .HasColumnName("estimated_media_tokens");
                    ...
                    b.Property<int?>("NumMatched")
                        .HasColumnType("integer")
                        .HasColumnName("num_matched");

                    b.Property<int>("NumPlaces")
                        .HasColumnType("integer")
                        .HasColumnName("num_places");

                    b.Property<int>("NumPlacesDropped")
                        .HasColumnType("integer")
                        .HasColumnName("num_places_dropped");
                    ...
                    b.ToTable("video_import_metrics");
                });
            ...
            modelBuilder.Entity("LocalList.API.NET.Shared.Data.Entities.Favorite", b =>
                {
                    b.HasOne("LocalList.API.NET.Shared.Data.Entities.Place", null)
                        .WithMany()
